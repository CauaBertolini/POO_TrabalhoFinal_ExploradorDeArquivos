...
public class Musica extends Midia {
     ...
     *
     * @throws CampoVazioOuNuloExcecao Se o nome, caminho ou artista forem vazios ou nulos
     * @throws IllegalArgumentException Se o gênero informado não for do tipo MUSICAL
     */
